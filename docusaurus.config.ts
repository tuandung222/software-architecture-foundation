      ...
      links: [
        {
          ...
          items: [
            ...
            {label: 'Phần 1: Giới thiệu SA', to: '/docs/01-introduction/01-overview'},
            {label: 'Phần 2: Design Principles', to: '/docs/02-design-principles/01-overview'},
            {label: 'Phần 3: Architectural Thinking', to: '/docs/03-architectural-thinking/01-overview'},
            {label: 'Phần 4: Quality Attributes', to: '/docs/04-quality-attributes/01-overview'},
            {label: 'Phần 5: Fundamental Styles', to: '/docs/05-fundamental-styles/01-overview'},
            {label: 'Phần 6: Distributed Styles', to: '/docs/06-distributed-styles/01-overview'},
            {label: 'Phần 7: Documenting', to: '/docs/07-documenting/01-overview'},
            {label: 'Phần 8: Case Studies', to: '/docs/08-case-studies/01-overview'},
            {label: 'Phần 9: Seminar', to: '/docs/09-seminar-advanced-topics/01-overview'},
          ],
        },
        {
          title: 'Tài nguyên',
